...
## 🔗Compatibility সেকশন (এটি খুব গুরুত্বপূর্ণ)
অনেক ইউজার কনফিউজড থাকে যে তাদের রাউটারে এটি চলবে কি না। তাই এটি যোগ করলে ভুল ইন্সটলেশন কমবে:
Compatibility:
Works on OpenWrt 21.02, 22.03, and 23.05+.
Tested on [TP-Link, Xiaomi, Linksys].
...
```bash
wget -qO /tmp/uninstall.sh https://raw.githubusercontent.com/jahid421/OpenWrt-BDIX-Dash/refs/heads/main/uninstall.sh && sed -i 's/\r$//' /tmp/uninstall.sh && sh /tmp/uninstall.sh && rm /tmp/uninstall.sh
```
